	...
	return (
		<aside className="w-[5%] h-full">
			<div className="grid justify-between h-full">
				<div>
					<div className="*:bg-foreground *:text-white *:size-8 *:rounded-sm *:p-1.5 grid gap-1.5">
						<AiFillLike />
						<Trophy />
						<FaAward />
					</div>
				...
				<div className="self-end">
					<div className="rounded-t-sm">
						<div className="bg-foreground py-4 size-8 rounded-t-sm flex justify-center items-center">
